...
const fin = fetchUSDEUR(url1).then(respuesta => respuesta.json()).then((data1) => { console.log(data1.eur) })
...
const Final = console.log(isNaN(fin))
...
const fin2 = fetchUSDbrl(url3).then(res => res.json()).then((data3) => console.log(data3))
